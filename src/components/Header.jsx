  ...
  return (
    ...
    border-black border-2 bg-white'>
        <Link to='/' className='flex py-4 align-middle justify-center border-black border-r-2'>
            <img src={Logo} alt='' width='137' height='15'/>
        </Link>

        <Link to='/contact' className='md:col-start-3 border-black md:border-1-2
        flex gap-2 items-center justify-center text-lg bg-yellow-300 hover:bg-yellow-500 ease-in-out duration-75'>
        ...
        <nav className='col-span-2 md:row-start-1
        md:col-start-2 md:col-end-3 border-t-2 border-black md:border-t-0
